...
pacman::p_load(sf, tidyverse, matrixStats, ggplot2, ggpubr, ggstatsplot, heatmaply, 
               GWmodel, SpatialML, tmap, rsample, Metrics, knitr, kableExtra, httr, jsonlite, rvest)
```
...
2.  Run the following query:
    -   \[out:json\]\[timeout:25\]; area\["name"="Singapore"\]-\>.searchArea; ( node["shop"="mall"](area.searchArea); way["shop"="mall"](area.searchArea); relation["shop"="mall"](area.searchArea); ); out body; \>; out skel qt;
...
# Check output
head(resale_merge_sf)
```

## 2.4 Proximity Calculation

::: callout-note
Since my seniors have graciously provided with a function to calculate proximity (from [Megan](https://is415-msty.netlify.app/posts/2021-10-25-take-home-exercise-3/)), I will gratefully leverage it in the subsequent steps.
:::
...
::: callout-note
Similar to proximity, my seniors have graciously provided with a function to calculate proximity (also from [Megan](https://is415-msty.netlify.app/posts/2021-10-25-take-home-exercise-3/)).
:::
